...
},{"./vue/containers/ContentAbout.vue":7,"./vue/containers/Header.vue":8,"vue":3}],6:[function(require,module,exports){
...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".page-container[data-v-bc53b4e4] {\n  padding-top: 60px;\n}\n.page-container .content[data-v-bc53b4e4] {\n  border: 1px solid grey;\n  padding: 10px;\n  border-radius: 2px;\n}")
;(function(){
"use strict";
...
exports.default = {
  data: function data() {
    return {
      content: [{ title: "uno", description: "" }, { title: "due", description: "" }, { title: "tre", description: "" }, { title: "quattro", description: "" }, { title: "cique", description: "" }]
    };
  }
};
})()
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"container page-container"},_vm._l((_vm.content),function(item){return _c('div',{staticClass:"content"},[_c('h2',[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('p',[_vm._v(_vm._s(item.description))])])}))}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-bc53b4e4"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bc53b4e4", __vue__options__)
  } else {
    hotAPI.reload("data-v-bc53b4e4", __vue__options__)
  }
})()}
